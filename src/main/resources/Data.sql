...
INSERT INTO hotels (hotel_code, hotel_name, destination, room_type, amount, date_from, date_to, reserved)
VALUES
    ('CH-0002', 'Cataratas Hotel', 'Puerto Iguazú', 'Doble', 6300, '2025-02-10', '2025-03-20', 'NO'),
    ('CH-0003', 'Cataratas Hotel 2', 'Puerto Iguazú', 'Triple', 8200, '2025-02-10', '2025-03-23', 'NO'),
    ('HB-0001', 'Hotel Bristol', 'Buenos Aires', 'Single', 5435, '2025-02-10', '2025-03-19', 'NO'),
    ('BH-0002', 'Hotel Bristol 2', 'Buenos Aires', 'Doble', 7200, '2025-02-12', '2025-04-17', 'NO'),
    ('SH-0002', 'Sheraton', 'Tucumán', 'Doble', 5790, '2025-04-17', '2025-05-23', 'NO'),
    ('SH-0001', 'Sheraton 2', 'Tucumán', 'Single', 4150, '2025-01-02', '2025-02-19', 'NO'),
    ('SE-0001', 'Selina', 'Bogotá', 'Single', 3900, '2025-01-23', '2025-11-23', 'NO'),
    ('SE-0002', 'Selina 2', 'Bogotá', 'Doble', 5840, '2025-01-23', '2025-10-15', 'NO'),
    ('EC-0003', 'El Campín', 'Bogotá', 'Triple', 7020, '2025-02-15', '2025-03-27', 'NO'),
    ('CP-0004', 'Central Plaza', 'Medellín', 'Múltiple', 8600, '2025-03-01', '2025-04-17', 'NO'),
    ('CP-0002', 'Central Plaza 2', 'Medellín', 'Doble', 6400, '2025-02-10', '2025-03-20', 'NO'),
    ('BG-0004', 'Bocagrande', 'Cartagena', 'Múltiple', 9370, '2025-04-17', '2025-06-12', 'NO');
...
INSERT INTO bookings (destination, date_from, date_to, hotel_code, people_amount, room_type, payment_method_id, hotel_id, cliente_id)
VALUES ('Cataratas Hotel', '2025-02-10', '2025-03-20', 'CH-0002', 2, 'DOBLE', 1, 4,1);
